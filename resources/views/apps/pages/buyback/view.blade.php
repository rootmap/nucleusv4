				                    			...
				                    			<div class="col-md-12">
					                    			<fieldset class="">
														<div class="input-group">
															...
															<input readonly="readonly"  style="background: white;" type="text" class="form-control" placeholder="Button on right" aria-describedby="button-addon6" value="{{$dataTable->created_at}}">
														</div>
													</fieldset>
						                        </div>
				                    		</div>
				                    			...
				                    			<div class="col-md-12">
					                    			<fieldset class="">
														<div class="input-group">
															...
															<input readonly="readonly" style="background: white;" type="text" class="form-control" placeholder="Button on right" aria-describedby="button-addon6" value="{{$customer->created_at}}">
														</div>
													</fieldset>
						                        </div>
				                    		</div>
