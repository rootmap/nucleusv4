				                    			...
				                    			<div class="col-md-12">
					                    			<fieldset class="">
														<div class="input-group">
															...
															<input readonly="readonly"  style="background: white;" type="text" class="form-control" placeholder="Button on right" aria-describedby="button-addon6" value="{{$data->created_at}}">
														</div>
													</fieldset>
						                        </div>
				                    		</div>  
										...
										<div class="form-body">
				                    		...
				                    		<div class="row" style="margin-bottom: 15px;">
				                    			<div class="col-md-12">
					                    			<fieldset class="">
														<div class="input-group">
															<a class="btn btn-info btn-block" href="{{url('parts/order/ticket/'.$data->ticket_id)}}"> 
					                    			...
					                    			<fieldset class="">
														<div class="input-group">
															...
															@if($data->payment_status=="Pending")
																<a class="btn btn-info btn-block" style="border-top-left-radius: 0px; border-bottom-left-radius: 0px;" href="{{url('pos/ticket/'.$data->ticket_id)}}"> 
