	                            ...
	                            <div class="row">
	                                ...
	                                <div class="col-md-12">
	                                    ...
	                                    <div class="input-group" style="margin-top:32px;">
											...
											<a href="javascript:void(0);" data-url="{{url('report/highestseller/excel/report')}}" class="btn btn-info btn-darken-2 mr-1 change-action">
												<i class="icon-file-excel-o"></i> Generate Excel
											</a>
											<a href="javascript:void(0);" data-url="{{url('report/highestseller/pdf/report')}}" class="btn btn-info btn-darken-3 mr-1 change-action">
												<i class="icon-file-pdf-o"></i> Generate PDF
											</a>
											<a href="{{url('report/highestseller')}}" style="margin-left: 5px;" class="btn btn-info btn-darken-4">
