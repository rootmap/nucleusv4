		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-card-center"><i class="icon-filter_list"></i> Ticket Report Filter</h4>
				...
				<div class="card-body collapse in">
					<div class="card-block">
						<form method="post" action="{{url('ticket/report')}}">
							{{csrf_field()}}
	                            ...
	                            <div class="row">
	                                ...
	                                <div class="col-md-12">
	                                    ...
	                                    <div class="input-group" style="margin-top:32px;">
											...
											<a href="javascript:void(0);" data-url="{{url('ticket/excel/report')}}" class="btn btn-info btn-darken-2 mr-1 change-action">
												<i class="icon-file-excel-o"></i> Generate Excel
											</a>
											<a href="javascript:void(0);" data-url="{{url('ticket/pdf/report')}}" class="btn btn-info btn-darken-3 mr-1 change-action">
												<i class="icon-file-pdf-o"></i> Generate PDF
											</a>
											<a href="{{url('ticket/report')}}" style="margin-left: 5px;" class="btn btn-info btn-darken-4">
