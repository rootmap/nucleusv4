	                            ...
	                            <div class="row">
	                                ...
	                                <div class="col-md-12">
	                                    ...
	                                    <div class="input-group" style="margin-top:32px;">
											...
											<a href="javascript:void(0);" data-url="{{url('lcd/status/excel/report')}}" class="btn btn-info btn-darken-2 mr-1 change-action">
												<i class="icon-file-excel-o"></i> Generate Excel
											</a>
											<a href="javascript:void(0);" data-url="{{url('lcd/status/pdf/report')}}" class="btn btn-info btn-darken-3 mr-1 change-action">
												<i class="icon-file-pdf-o"></i> Generate PDF
											</a>
											<a href="{{url('lcd/status/report')}}" style="margin-left: 5px;" class="btn btn-info btn-darken-4">
			...
			<div class="card-body collapse in">
				<div class="table-responsive">
					<table class="table table-striped table-bordered zero-configuration">
                        ...
                        <div class="col-lg-4 col-sm-4 border-right-blue bg-info  bg-lighten-2 border-right-lighten-4">
                            <div class="card-block text-xs-center">
