		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-card-center"><i class="icon-filter_list"></i> Buyback Report Filter</h4>
				...
				<div class="card-body collapse in">
					<div class="card-block">
						<form method="post" action="{{url('report/buyback')}}">
							{{csrf_field()}}
							<fieldset class="form-group">
	                            <div class="row">
	                                ...
	                                <div class="col-md-2">
	                                    <h4>Parts | Sale</h4>
	                                    <div class="input-group">
											<select name="keep_this_on" class="select2 form-control">
												<option value="">Select a Parts | Sale</option>
													<option 
													 @if(!empty($keep_this_on)) 
													 	@if($keep_this_on=="Parts")
				                                        	selected="selected"  
				                                        @endif
				                                     @endif 
	                                ...
	                                <div class="col-md-12">
	                                    ...
	                                    <div class="input-group" style="margin-top:32px;">
											...
											<a href="javascript:void(0);" data-url="{{url('report/excel/buyback')}}" class="btn btn-info btn-darken-2 mr-1 change-action">
												<i class="icon-file-excel-o"></i> Generate Excel
											</a>
											<a href="javascript:void(0);" data-url="{{url('report/pdf/buyback')}}" class="btn btn-info btn-darken-3 mr-1 change-action">
												<i class="icon-file-pdf-o"></i> Generate PDF
											</a>
											<a href="{{url('report/buyback')}}" style="margin-left: 5px;" class="btn btn-info btn-darken-4">
...
<div class="row">
	<div class="col-xs-12">
		<div class="card">
			<div class="card-header">
				<h4 class="card-title"><i class="icon-clear_all"></i> Buyback Report</h4>
				<a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
        		<div class="heading-elements">
					<ul class="list-inline mb-0">
						<li><a data-action="collapse"><i class="icon-minus4"></i></a></li>
