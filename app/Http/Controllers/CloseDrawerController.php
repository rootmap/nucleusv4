...
class CloseDrawerController extends Controller
{
    ...
    public function exportExcel(Request $request) 
    {
        ...
        foreach($inv as $voi):
            $inv_arry=array($voi->id,$voi->opeing_time,$voi->opening_amount,$voi->closing_time,$voi->closing_amount,$voi->cashier_name);
        ...
        $html='<table class="table table-bordered" style="width:100%;">
                ...
                <tbody>';
                    ...
                    foreach($inv as $voi):
                        ...
                        <td style="font-size:12px;" class="text-center">'.$voi->opeing_time.'</td>
                        <td style="font-size:12px;" class="text-center">'.$voi->opening_amount.'</td>
                        <td style="font-size:12px;" class="text-center">'.$voi->closing_time.'</td>
